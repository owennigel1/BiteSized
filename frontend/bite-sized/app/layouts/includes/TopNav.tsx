        ...
        >
          ...
          <div className="flex items-center gap-3 ">
            ...
            >
              ...
              {/* buat penjual kutambahin tombol upload */}
              <span className="px-2 font-medium text-[15px]">Upload</span>
              {/* bisa dihapus aja kalo gak perlu */}
            </button>
            ...
            {true ? ( 
                ...
                <div className="flex items-center">
                    <div className="relative">
                        <button
                            className="mt-1 border-gray-200 rounded-full"
                        >
                            <img className="rounded-full w-[35px] h-[35px]" src="https://placeholder.co/35" alt="" />
