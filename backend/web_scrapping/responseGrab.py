...
combined_list_file_path = "backend/web_scrapping/combined_listArray.txt"
...
output_folder = "backend/web_scrapping/responses"
...
output_file_path = "backend/web_scrapping/all_responses.ndjson.gz"
